...
echo "<div>";
 ...
 echo "
	...
	$sql="select stockval.symbol, symbols.name, time_stamp, value, stockval.change, day_low, day_high, week_low, week_high, change_perc from stockval, (select symbol, max(time_stamp) as lt from stockval group  by symbol)  as u, symbols where stockval.symbol=u.symbol  and stockval.time_stamp=u.lt and stockval.symbol = symbols.symbol";
