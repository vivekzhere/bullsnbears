...
<?php		  // Total Ranking
			...
			$out = "<h2>Leaderboard</h2><br/><table>
		<tr>
			<th>Rank</th><th></th><th>Name</th><th>Net Worth</th>
		</tr>"; $i = 0;
			while($player = mysql_fetch_assoc($resultset)){
				$i = $i+1;
				$flag = 1;
				$out .= "\n<tr ";
				if($flag == 1){
				...
				$out .=">\n";
				$out .="<td>$i</td>";
				$player['tot'] = convertcash($player['tot'],"Rs. ");
		...
		?>
			...
			$resultset = mysql_query($sql) or die(mysql_error());
			$out = "<h2></br></br>This Week's Leaders</h2><br/><table id=\"weekwinners\">
		<tr>
