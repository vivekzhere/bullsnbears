...
<body>
<div id="content">
	<?php navigation("help"); ?><br/><br/>
	<div id="help">
		<h2>Help</h2><button id="helpShow" class="shinybutton" onclick="updateHelp();">Show Rules</button>
				<ul>
				<li> What Are Stocks?
	...
	<div id='help2'>
		<h2>Rules</h2><button id="helpShow2" class="shinybutton" onclick="updateHelp()">Show Help</button>
					<ul>
				<li> General
