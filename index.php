	...
	<div id="content">
		...
		<div id="content_main">
			...
			<div id="fb" style="height: 300px;">
				...
				<br/><br/>
				<a href="https://www.facebook.com/dialog/oauth/?client_id=106257179526701&redirect_uri=http://bullsnbears.tathva.org/index.php&state=8ad4c82bdbf012cf77c6538f5a976279&scope=email&display=popup"><div id="loginbutton" style="width=100px;height=20px;"></div></			</div><!-- fb box -->
		</div><!-- content_main -->
	</div>
</body>
</html>
